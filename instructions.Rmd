...
Indicators are calculated for each primary key. In wide format, there is a row for each primary key value and a column for each indicator (each unique grouping when using grouping variables). In tall format, there is a column each for primary keys, indicator, and indicator value with each row representing a unique combination of indicator and primary key.
